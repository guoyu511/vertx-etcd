...
public  final class AlarmResponse extends
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              alarms_ = new java.util.ArrayList<com.coreos.jetcd.api.AlarmMember>();
              mutable_bitField0_ |= 0x00000002;
            }
            alarms_.add(
                input.readMessage(com.coreos.jetcd.api.AlarmMember.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AlarmResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.jetcd.api.AlarmResponse.class, com.coreos.jetcd.api.AlarmResponse.Builder.class);
  }
  ...
  private java.util.List<com.coreos.jetcd.api.AlarmMember> alarms_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.coreos.jetcd.api.AlarmMember> getAlarmsList() {
    return alarms_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public java.util.List<? extends com.coreos.jetcd.api.AlarmMemberOrBuilder> 
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public com.coreos.jetcd.api.AlarmMember getAlarms(int index) {
   ...
   * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
   */
  public com.coreos.jetcd.api.AlarmMemberOrBuilder getAlarmsOrBuilder(
      int index) {
    return alarms_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.coreos.jetcd.api.AlarmResponse)) {
      return super.equals(obj);
    }
    com.coreos.jetcd.api.AlarmResponse other = (com.coreos.jetcd.api.AlarmResponse) obj;
  ...
  public static com.coreos.jetcd.api.AlarmResponse parseFrom(
  ...
  public static com.coreos.jetcd.api.AlarmResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.jetcd.api.AlarmResponse parseFrom(
  ...
  public static com.coreos.jetcd.api.AlarmResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.jetcd.api.AlarmResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.coreos.jetcd.api.AlarmResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.coreos.jetcd.api.AlarmResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public com.coreos.jetcd.api.AlarmResponse getDefaultInstanceForType() {
      return com.coreos.jetcd.api.AlarmResponse.getDefaultInstance();
    }

    public com.coreos.jetcd.api.AlarmResponse build() {
      com.coreos.jetcd.api.AlarmResponse result = buildPartial();
    ...
    public com.coreos.jetcd.api.AlarmResponse buildPartial() {
      com.coreos.jetcd.api.AlarmResponse result = new com.coreos.jetcd.api.AlarmResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.jetcd.api.AlarmResponse) {
        return mergeFrom((com.coreos.jetcd.api.AlarmResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.jetcd.api.AlarmResponse other) {
      if (other == com.coreos.jetcd.api.AlarmResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.jetcd.api.AlarmResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.jetcd.api.AlarmResponse) e.getUnfinishedMessage();
    ...
    private void ensureAlarmsIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        alarms_ = new java.util.ArrayList<com.coreos.jetcd.api.AlarmMember>(alarms_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.jetcd.api.AlarmMember, com.coreos.jetcd.api.AlarmMember.Builder, com.coreos.jetcd.api.AlarmMemberOrBuilder> alarmsBuilder_;
    ...
    public Builder setAlarms(
        int index, com.coreos.jetcd.api.AlarmMember value) {
      if (alarmsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setAlarms(
        int index, com.coreos.jetcd.api.AlarmMember.Builder builderForValue) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public Builder addAlarms(com.coreos.jetcd.api.AlarmMember value) {
      if (alarmsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addAlarms(
        com.coreos.jetcd.api.AlarmMember.Builder builderForValue) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
    ...
    public Builder addAllAlarms(
        java.lang.Iterable<? extends com.coreos.jetcd.api.AlarmMember> values) {
      if (alarmsBuilder_ == null) {
        ensureAlarmsIsMutable();
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public com.coreos.jetcd.api.AlarmMember.Builder getAlarmsBuilder(
        int index) {
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public com.coreos.jetcd.api.AlarmMember.Builder addAlarmsBuilder() {
      return getAlarmsFieldBuilder().addBuilder(
          com.coreos.jetcd.api.AlarmMember.getDefaultInstance());
    }
    /**
     * <pre>
     * alarms is a list of alarms associated with the alarm request.
    ...
    public com.coreos.jetcd.api.AlarmMember.Builder addAlarmsBuilder(
        int index) {
      return getAlarmsFieldBuilder().addBuilder(
          index, com.coreos.jetcd.api.AlarmMember.getDefaultInstance());
    }
    /**
     * <pre>
     * alarms is a list of alarms associated with the alarm request.
     ...
     * <code>repeated .etcdserverpb.AlarmMember alarms = 2;</code>
     */
    public java.util.List<com.coreos.jetcd.api.AlarmMember.Builder> 
         getAlarmsBuilderList() {
      return getAlarmsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.jetcd.api.AlarmMember, com.coreos.jetcd.api.AlarmMember.Builder, com.coreos.jetcd.api.AlarmMemberOrBuilder> 
        getAlarmsFieldBuilder() {
      if (alarmsBuilder_ == null) {
  ...
  private static final com.coreos.jetcd.api.AlarmResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.jetcd.api.AlarmResponse();
  }

  public static com.coreos.jetcd.api.AlarmResponse getDefaultInstance() {
