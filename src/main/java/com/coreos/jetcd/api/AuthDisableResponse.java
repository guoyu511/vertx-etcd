...
public  final class AuthDisableResponse extends
  ...
  protected FieldAccessorTable
    ...
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AuthDisableResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AuthDisableResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AuthDisableResponse)) {
      return super.equals(obj);
    }
    AuthDisableResponse other = (AuthDisableResponse) obj;
  ...
  public static AuthDisableResponse parseFrom(
  ...
  public static AuthDisableResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static AuthDisableResponse parseFrom(
  ...
  public static AuthDisableResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static AuthDisableResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static AuthDisableResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(AuthDisableResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public AuthDisableResponse getDefaultInstanceForType() {
      return AuthDisableResponse.getDefaultInstance();
    }

    public AuthDisableResponse build() {
      AuthDisableResponse result = buildPartial();
    ...
    public AuthDisableResponse buildPartial() {
      AuthDisableResponse result = new AuthDisableResponse(this);
      if (headerBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof AuthDisableResponse) {
        return mergeFrom((AuthDisableResponse)other);
      } else {
    ...
    public Builder mergeFrom(AuthDisableResponse other) {
      if (other == AuthDisableResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      AuthDisableResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (AuthDisableResponse) e.getUnfinishedMessage();
  ...
  private static final AuthDisableResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AuthDisableResponse();
  }

  public static AuthDisableResponse getDefaultInstance() {
