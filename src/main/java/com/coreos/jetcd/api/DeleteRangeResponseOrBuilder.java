...
public interface DeleteRangeResponseOrBuilder extends
   ...
   */
  java.util.List<com.coreos.jetcd.api.KeyValue> 
      getPrevKvsList();
  /**
   * <pre>
   * if prev_kv is set in the request, the previous key-value pairs will be returned.
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  com.coreos.jetcd.api.KeyValue getPrevKvs(int index);
  /**
   * <pre>
   * if prev_kv is set in the request, the previous key-value pairs will be returned.
   * </pre>
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  java.util.List<? extends com.coreos.jetcd.api.KeyValueOrBuilder> 
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  com.coreos.jetcd.api.KeyValueOrBuilder getPrevKvsOrBuilder(
      int index);
}
