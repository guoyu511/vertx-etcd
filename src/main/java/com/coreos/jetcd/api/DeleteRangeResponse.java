...
public  final class DeleteRangeResponse extends
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              prevKvs_ = new java.util.ArrayList<com.coreos.jetcd.api.KeyValue>();
              mutable_bitField0_ |= 0x00000004;
            }
            prevKvs_.add(
                input.readMessage(com.coreos.jetcd.api.KeyValue.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_DeleteRangeResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_DeleteRangeResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.jetcd.api.DeleteRangeResponse.class, com.coreos.jetcd.api.DeleteRangeResponse.Builder.class);
  }
  ...
  private java.util.List<com.coreos.jetcd.api.KeyValue> prevKvs_;
  /**
   * <pre>
   ...
   */
  public java.util.List<com.coreos.jetcd.api.KeyValue> getPrevKvsList() {
    return prevKvs_;
  }
  /**
   * <pre>
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  public java.util.List<? extends com.coreos.jetcd.api.KeyValueOrBuilder> 
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  public com.coreos.jetcd.api.KeyValue getPrevKvs(int index) {
   ...
   * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
   */
  public com.coreos.jetcd.api.KeyValueOrBuilder getPrevKvsOrBuilder(
      int index) {
    return prevKvs_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.coreos.jetcd.api.DeleteRangeResponse)) {
      return super.equals(obj);
    }
    com.coreos.jetcd.api.DeleteRangeResponse other = (com.coreos.jetcd.api.DeleteRangeResponse) obj;
  ...
  public static com.coreos.jetcd.api.DeleteRangeResponse parseFrom(
  ...
  public static com.coreos.jetcd.api.DeleteRangeResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.jetcd.api.DeleteRangeResponse parseFrom(
  ...
  public static com.coreos.jetcd.api.DeleteRangeResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.jetcd.api.DeleteRangeResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.coreos.jetcd.api.DeleteRangeResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.coreos.jetcd.api.DeleteRangeResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.coreos.jetcd.api.DeleteRangeResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_DeleteRangeResponse_descriptor;
    }
    ...
    // Construct using com.coreos.jetcd.api.DeleteRangeResponse.newBuilder()
    private Builder() {
    ...
    public com.coreos.jetcd.api.DeleteRangeResponse getDefaultInstanceForType() {
      return com.coreos.jetcd.api.DeleteRangeResponse.getDefaultInstance();
    }

    public com.coreos.jetcd.api.DeleteRangeResponse build() {
      com.coreos.jetcd.api.DeleteRangeResponse result = buildPartial();
    ...
    public com.coreos.jetcd.api.DeleteRangeResponse buildPartial() {
      com.coreos.jetcd.api.DeleteRangeResponse result = new com.coreos.jetcd.api.DeleteRangeResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.jetcd.api.DeleteRangeResponse) {
        return mergeFrom((com.coreos.jetcd.api.DeleteRangeResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.jetcd.api.DeleteRangeResponse other) {
      if (other == com.coreos.jetcd.api.DeleteRangeResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.jetcd.api.DeleteRangeResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.jetcd.api.DeleteRangeResponse) e.getUnfinishedMessage();
    ...
    private void ensurePrevKvsIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        prevKvs_ = new java.util.ArrayList<com.coreos.jetcd.api.KeyValue>(prevKvs_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.coreos.jetcd.api.KeyValue, com.coreos.jetcd.api.KeyValue.Builder, com.coreos.jetcd.api.KeyValueOrBuilder> prevKvsBuilder_;
    ...
    public Builder setPrevKvs(
        int index, com.coreos.jetcd.api.KeyValue value) {
      if (prevKvsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setPrevKvs(
        int index, com.coreos.jetcd.api.KeyValue.Builder builderForValue) {
      if (prevKvsBuilder_ == null) {
        ensurePrevKvsIsMutable();
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public Builder addPrevKvs(com.coreos.jetcd.api.KeyValue value) {
      if (prevKvsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllPrevKvs(
        java.lang.Iterable<? extends com.coreos.jetcd.api.KeyValue> values) {
      if (prevKvsBuilder_ == null) {
        ensurePrevKvsIsMutable();
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public com.coreos.jetcd.api.KeyValue.Builder getPrevKvsBuilder(
        int index) {
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public com.coreos.jetcd.api.KeyValue.Builder addPrevKvsBuilder() {
      return getPrevKvsFieldBuilder().addBuilder(
          com.coreos.jetcd.api.KeyValue.getDefaultInstance());
    }
    /**
     * <pre>
     * if prev_kv is set in the request, the previous key-value pairs will be returned.
    ...
    public com.coreos.jetcd.api.KeyValue.Builder addPrevKvsBuilder(
        int index) {
      return getPrevKvsFieldBuilder().addBuilder(
          index, com.coreos.jetcd.api.KeyValue.getDefaultInstance());
    }
    /**
     * <pre>
     * if prev_kv is set in the request, the previous key-value pairs will be returned.
     ...
     * <code>repeated .mvccpb.KeyValue prev_kvs = 3;</code>
     */
    public java.util.List<com.coreos.jetcd.api.KeyValue.Builder> 
  ...
  private static final com.coreos.jetcd.api.DeleteRangeResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.jetcd.api.DeleteRangeResponse();
  }

  public static com.coreos.jetcd.api.DeleteRangeResponse getDefaultInstance() {
