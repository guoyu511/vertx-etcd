...
public  final class AuthUserGetResponse extends
  ...
  protected FieldAccessorTable
    ...
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AuthUserGetResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AuthUserGetResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AuthUserGetResponse)) {
      return super.equals(obj);
    }
    AuthUserGetResponse other = (AuthUserGetResponse) obj;
  ...
  public static AuthUserGetResponse parseFrom(
  ...
  public static AuthUserGetResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static AuthUserGetResponse parseFrom(
  ...
  public static AuthUserGetResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static AuthUserGetResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static AuthUserGetResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(AuthUserGetResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public AuthUserGetResponse getDefaultInstanceForType() {
      return AuthUserGetResponse.getDefaultInstance();
    }

    public AuthUserGetResponse build() {
      AuthUserGetResponse result = buildPartial();
    ...
    public AuthUserGetResponse buildPartial() {
      AuthUserGetResponse result = new AuthUserGetResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof AuthUserGetResponse) {
        return mergeFrom((AuthUserGetResponse)other);
      } else {
    ...
    public Builder mergeFrom(AuthUserGetResponse other) {
      if (other == AuthUserGetResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      AuthUserGetResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (AuthUserGetResponse) e.getUnfinishedMessage();
  ...
  private static final AuthUserGetResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AuthUserGetResponse();
  }

  public static AuthUserGetResponse getDefaultInstance() {
