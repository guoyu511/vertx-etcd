...
public interface WatchResponseOrBuilder extends
   ...
   */
  java.util.List<com.coreos.jetcd.api.Event> 
      getEventsList();
  /**
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  com.coreos.jetcd.api.Event getEvents(int index);
  /**
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  int getEventsCount();
   ...
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  java.util.List<? extends com.coreos.jetcd.api.EventOrBuilder> 
      getEventsOrBuilderList();
  /**
   * <code>repeated .mvccpb.Event events = 11;</code>
   */
  com.coreos.jetcd.api.EventOrBuilder getEventsOrBuilder(
      int index);
}
