...
public  final class AuthUserRevokeRoleResponse extends
  ...
  protected FieldAccessorTable
    ...
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AuthUserRevokeRoleResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AuthUserRevokeRoleResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AuthUserRevokeRoleResponse)) {
      return super.equals(obj);
    }
    AuthUserRevokeRoleResponse other = (AuthUserRevokeRoleResponse) obj;
  ...
  public static AuthUserRevokeRoleResponse parseFrom(
  ...
  public static AuthUserRevokeRoleResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static AuthUserRevokeRoleResponse parseFrom(
  ...
  public static AuthUserRevokeRoleResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static AuthUserRevokeRoleResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static AuthUserRevokeRoleResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(AuthUserRevokeRoleResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public AuthUserRevokeRoleResponse getDefaultInstanceForType() {
      return AuthUserRevokeRoleResponse.getDefaultInstance();
    }

    public AuthUserRevokeRoleResponse build() {
      AuthUserRevokeRoleResponse result = buildPartial();
    ...
    public AuthUserRevokeRoleResponse buildPartial() {
      AuthUserRevokeRoleResponse result = new AuthUserRevokeRoleResponse(this);
      if (headerBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof AuthUserRevokeRoleResponse) {
        return mergeFrom((AuthUserRevokeRoleResponse)other);
      } else {
    ...
    public Builder mergeFrom(AuthUserRevokeRoleResponse other) {
      if (other == AuthUserRevokeRoleResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      AuthUserRevokeRoleResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (AuthUserRevokeRoleResponse) e.getUnfinishedMessage();
  ...
  private static final AuthUserRevokeRoleResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AuthUserRevokeRoleResponse();
  }

  public static AuthUserRevokeRoleResponse getDefaultInstance() {
