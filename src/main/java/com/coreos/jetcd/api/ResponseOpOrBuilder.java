...
public interface ResponseOpOrBuilder extends
   ...
   */
  com.coreos.jetcd.api.RangeResponse getResponseRange();
  /**
   * <code>.etcdserverpb.RangeResponse response_range = 1;</code>
   */
  com.coreos.jetcd.api.RangeResponseOrBuilder getResponseRangeOrBuilder();

  /**
   * <code>.etcdserverpb.PutResponse response_put = 2;</code>
   */
  com.coreos.jetcd.api.PutResponse getResponsePut();
  /**
   * <code>.etcdserverpb.PutResponse response_put = 2;</code>
   */
  com.coreos.jetcd.api.PutResponseOrBuilder getResponsePutOrBuilder();

  /**
   * <code>.etcdserverpb.DeleteRangeResponse response_delete_range = 3;</code>
   */
  com.coreos.jetcd.api.DeleteRangeResponse getResponseDeleteRange();
  /**
   * <code>.etcdserverpb.DeleteRangeResponse response_delete_range = 3;</code>
   */
  com.coreos.jetcd.api.DeleteRangeResponseOrBuilder getResponseDeleteRangeOrBuilder();
  ...
  public com.coreos.jetcd.api.ResponseOp.ResponseCase getResponseCase();
}
