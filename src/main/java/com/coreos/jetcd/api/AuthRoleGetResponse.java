...
public  final class AuthRoleGetResponse extends
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
              perm_ = new java.util.ArrayList<com.coreos.jetcd.api.Permission>();
              mutable_bitField0_ |= 0x00000002;
            }
            perm_.add(
                input.readMessage(com.coreos.jetcd.api.Permission.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AuthRoleGetResponse_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AuthRoleGetResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.coreos.jetcd.api.AuthRoleGetResponse.class, com.coreos.jetcd.api.AuthRoleGetResponse.Builder.class);
  }
  ...
  private java.util.List<com.coreos.jetcd.api.Permission> perm_;
  /**
   * <code>repeated .authpb.Permission perm = 2;</code>
   */
  public java.util.List<com.coreos.jetcd.api.Permission> getPermList() {
    return perm_;
  }
  /**
   * <code>repeated .authpb.Permission perm = 2;</code>
   */
  public java.util.List<? extends com.coreos.jetcd.api.PermissionOrBuilder> 
   ...
   * <code>repeated .authpb.Permission perm = 2;</code>
   */
  public com.coreos.jetcd.api.Permission getPerm(int index) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.coreos.jetcd.api.AuthRoleGetResponse)) {
      return super.equals(obj);
    }
    com.coreos.jetcd.api.AuthRoleGetResponse other = (com.coreos.jetcd.api.AuthRoleGetResponse) obj;
  ...
  public static com.coreos.jetcd.api.AuthRoleGetResponse parseFrom(
  ...
  public static com.coreos.jetcd.api.AuthRoleGetResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.coreos.jetcd.api.AuthRoleGetResponse parseFrom(
  ...
  public static com.coreos.jetcd.api.AuthRoleGetResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.coreos.jetcd.api.AuthRoleGetResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.coreos.jetcd.api.AuthRoleGetResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.coreos.jetcd.api.AuthRoleGetResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.coreos.jetcd.api.AuthRoleGetResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AuthRoleGetResponse_descriptor;
    }
    ...
    // Construct using com.coreos.jetcd.api.AuthRoleGetResponse.newBuilder()
    private Builder() {
    ...
    public com.coreos.jetcd.api.AuthRoleGetResponse getDefaultInstanceForType() {
      return com.coreos.jetcd.api.AuthRoleGetResponse.getDefaultInstance();
    }

    public com.coreos.jetcd.api.AuthRoleGetResponse build() {
      com.coreos.jetcd.api.AuthRoleGetResponse result = buildPartial();
    ...
    public com.coreos.jetcd.api.AuthRoleGetResponse buildPartial() {
      com.coreos.jetcd.api.AuthRoleGetResponse result = new com.coreos.jetcd.api.AuthRoleGetResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.coreos.jetcd.api.AuthRoleGetResponse) {
        return mergeFrom((com.coreos.jetcd.api.AuthRoleGetResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.coreos.jetcd.api.AuthRoleGetResponse other) {
      if (other == com.coreos.jetcd.api.AuthRoleGetResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.coreos.jetcd.api.AuthRoleGetResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.coreos.jetcd.api.AuthRoleGetResponse) e.getUnfinishedMessage();
    ...
    private void ensurePermIsMutable() {
      if (!((bitField0_ & 0x00000002) == 0x00000002)) {
        perm_ = new java.util.ArrayList<com.coreos.jetcd.api.Permission>(perm_);
    ...
    public Builder setPerm(
        int index, com.coreos.jetcd.api.Permission value) {
      if (permBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setPerm(
        int index, com.coreos.jetcd.api.Permission.Builder builderForValue) {
      if (permBuilder_ == null) {
        ensurePermIsMutable();
     ...
     * <code>repeated .authpb.Permission perm = 2;</code>
     */
    public Builder addPerm(com.coreos.jetcd.api.Permission value) {
      if (permBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllPerm(
        java.lang.Iterable<? extends com.coreos.jetcd.api.Permission> values) {
      if (permBuilder_ == null) {
        ensurePermIsMutable();
     ...
     * <code>repeated .authpb.Permission perm = 2;</code>
     */
    public com.coreos.jetcd.api.Permission.Builder addPermBuilder() {
      return getPermFieldBuilder().addBuilder(
          com.coreos.jetcd.api.Permission.getDefaultInstance());
    }
    /**
     * <code>repeated .authpb.Permission perm = 2;</code>
     */
    public com.coreos.jetcd.api.Permission.Builder addPermBuilder(
        int index) {
      return getPermFieldBuilder().addBuilder(
          index, com.coreos.jetcd.api.Permission.getDefaultInstance());
    }
    /**
     * <code>repeated .authpb.Permission perm = 2;</code>
     */
    public java.util.List<com.coreos.jetcd.api.Permission.Builder> 
         getPermBuilderList() {
  ...
  private static final com.coreos.jetcd.api.AuthRoleGetResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.coreos.jetcd.api.AuthRoleGetResponse();
  }

  public static com.coreos.jetcd.api.AuthRoleGetResponse getDefaultInstance() {
