...
public  final class AuthUserDeleteResponse extends
  ...
  protected FieldAccessorTable
    ...
    return com.coreos.jetcd.api.JetcdProto.internal_static_etcdserverpb_AuthUserDeleteResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AuthUserDeleteResponse.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AuthUserDeleteResponse)) {
      return super.equals(obj);
    }
    AuthUserDeleteResponse other = (AuthUserDeleteResponse) obj;
  ...
  public static AuthUserDeleteResponse parseFrom(
  ...
  public static AuthUserDeleteResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static AuthUserDeleteResponse parseFrom(
  ...
  public static AuthUserDeleteResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static AuthUserDeleteResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static AuthUserDeleteResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(AuthUserDeleteResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public AuthUserDeleteResponse getDefaultInstanceForType() {
      return AuthUserDeleteResponse.getDefaultInstance();
    }

    public AuthUserDeleteResponse build() {
      AuthUserDeleteResponse result = buildPartial();
    ...
    public AuthUserDeleteResponse buildPartial() {
      AuthUserDeleteResponse result = new AuthUserDeleteResponse(this);
      if (headerBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof AuthUserDeleteResponse) {
        return mergeFrom((AuthUserDeleteResponse)other);
      } else {
    ...
    public Builder mergeFrom(AuthUserDeleteResponse other) {
      if (other == AuthUserDeleteResponse.getDefaultInstance()) return this;
      if (other.hasHeader()) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      AuthUserDeleteResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (AuthUserDeleteResponse) e.getUnfinishedMessage();
  ...
  private static final AuthUserDeleteResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AuthUserDeleteResponse();
  }

  public static AuthUserDeleteResponse getDefaultInstance() {
